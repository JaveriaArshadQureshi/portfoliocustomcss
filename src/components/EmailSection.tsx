  ...
  return (
    <section className='grid md:grid-cols-2 my-12 md:my-12 py-24 gap-4' id='contact'>
        ...
        <div className='socials flex flex-row gap-2'>
            ...
            <Link href={"https://www.linkedin.com/in/javeria-arshad-qureshi"}>
        ...
        <div>
          <form className='flex flex-col '>
           ...
           <label  htmlFor="subject"  className='text-white  block   text-sm font-medium'>Subject</label>
            ...
            <button
              type="submit"
              className="bg-gradient-to-br    from-pink-400 to-pink-500 hover:bg-slate-800 hover:brightness-90 mt-5 text-white font-medium py-2.5 px-5 rounded-lg w-full"
            >
              Send Message
            </button>
