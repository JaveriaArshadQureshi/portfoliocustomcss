...
const HeroSection = () => {
  return (
      ...
      <div className="grid grid-cols-1 sm:grid-cols-12 mt-10 md:mt-[150px]  md:mb-[150px] "  id="/">
        <div className="col-span-7 place-self-center text-center sm:text-left">
          <h1 className="text-white mb-4 font-extrabold text-4xl sm:text-5xl lg:text-6xl ">
            <span className="text-transparent bg-clip-text bg-gradient-to-br  from-[#F67C8C]  to-[#FB96A1]">
              {" "}
              Hello, I&apos;m{""}
            </span>
            <br/>
    ...
    />
          ...
          <div>
            <button className="py-3 px-6 w-full sm:w-fit rounded-full mr-4  text-white font-bold bg-gradient-to-br from-[#F67C8C]  to-[#FB96A1] hover:bg-slate-600">
              Hire Me
            </button>
            <button className="py-1 px-1 w-full sm:w-fit rounded-full text-white font-bold bg-gradient-to-br  from-[#F67C8C]  to-[#FB96A1] hover:bg-slate-800   mt-3 ">
        ...
        <div className="col-span-5 place-self-center mt-8 lg:mt-0">
          <div className="rounded-full bg-[#181818] w-[250px] h-[250px]  lg:w-[300px] lg:h-[300px] border-4 border-s-[#F67C8C] border-b-[#F67C8C] border-e-[#FB96A1] border-t-[#FB96A1] relative shadow-white shadow-lg">
            <Image
              src="/hero-pick.png"
              alt="hero-image"
